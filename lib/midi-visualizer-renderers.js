...
function accumulateScales(width, height, acc, events, index) {
   ...
   var minimumNoteValue = events.filter(isNoteEvent).reduce(minNote, maximumNoteValue);

   // console.log('track', index, events[0].track, 'width', width, 'height', height, 'max', maximumNoteValue, 'min', minimumNoteValue);
