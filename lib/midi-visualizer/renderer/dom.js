...
var filters = {
   /*
    * TODO: THIS IS WRONG!!!!
    *       IT NEEDS TO ONLY SET UP THE DATA, NOT MODIFY DOM NODES
    */
...
DomRenderer.prototype = Object.create(AbstractRenderer);
...
DomRenderer.prototype.transformMidiData = function transformMidiData(midiEvents) {
	console.log('TODO: generate animation data');
};
