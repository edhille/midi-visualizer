...
var AudioPlayer = require('./audio-player.js');
var midiRenderPipeline = require('./midi-visualizer/render-pipeline.js');
...
function handleMidiLoad(midiVisualizer, e, resolve, reject) {
   ...
   if (arrayBuffer) {
      ...
      midiVisualizer.midi = new MidiParser({ midiByteArray: byteArray });
      resolve();
   } else {
